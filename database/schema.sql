CREATE TABLE IF NOT EXISTS users (
    ...
    permissions VARCHAR(255) NOT NULL DEFAULT 'PLAYER',
    ...
    show_dealer_tile BOOLEAN NOT NULL DEFAULT TRUE,
    show_admin_tile BOOLEAN NOT NULL DEFAULT TRUE
);
...
CREATE TABLE IF NOT EXISTS dealers (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_dealers_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL,
